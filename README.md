# Helios Retail Partnership Pilot

60-day pre-sales support program submission form and dashboard.

## Deploy on GitHub Pages

1. Create a new repo at [github.com/new](https://github.com/new) (name it e.g. `helios-pilot`).
